...
export const Permissions = ({ users, presidentId, canEdit = false }) => {
  ...
  const casUsers = managedUsers.filter((user) => ["Presidente", "CAS"].includes(user.role)).sort(sortByUsername);
